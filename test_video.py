...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_name', default='test_videoLion1.mp4', type=str, help='test low resolution video name')
    ...
    output_sr_name = '/kaggle/working/out_srf_' + str(UPSCALE_FACTOR) + '_' + VIDEO_NAME.split('.')[0] + '.mp4'
